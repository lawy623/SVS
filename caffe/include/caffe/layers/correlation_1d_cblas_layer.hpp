#ifndef CORRELATION_1D_CBLAS_LAYER_HPP_
#define CORRELATION_1D_CBLAS_LAYER_HPP_
...
class Correlation1DCblasLayer : public Layer<Dtype> {
 public:

  explicit Correlation1DCblasLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "Correlation1DCblas"; }

#ifndef L1_LOSS_KITTI_LAYER_HPP_
#define L1_LOSS_KITTI_LAYER_HPP_
...
class L1LossKittiLayer : public LossLayer<Dtype> {
 public:
  explicit L1LossKittiLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "L1LossKitti"; }
...
#endif  // L1_LOSS_KITTI_LAYER_HPP_

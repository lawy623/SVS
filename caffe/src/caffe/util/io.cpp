...
#ifdef USE_MEMCACHED
  const std::string server_list_config_file = "/mnt/lustre/share/memcached_client/server_list.conf";
  const std::string client_config_file = "/mnt/lustre/share/memcached_client/client.conf";
